...
-- AtlasOrbitAddress (F1-free): prime-power sites (n,t), Archimedean sites (x,s), THE ORBIT QUOTIENT ScaleOrbitAddr = positive rationals mod Qeq (a genuine Quotient), n·s = x·t ⟺ equal orbit addresses, THE PULLBACK CouplingAddr over equality with its universal property, COMPLETENESS (equal orbit ⟺ unique positive scaling), channel-indexed dependent address types, and the anchor s = x·t/n (t = n·s/x): existence and uniqueness
...
#print axioms Square.posRat_eqv_refl
#print axioms Square.posRat_eqv_symm
#print axioms Square.posRat_eqv_trans
#print axioms Square.Qmul_num_pos
#print axioms Square.onOrbit_iff_orbitRat
...
#print axioms Square.Qinv_congr_pr
#print axioms Square.Qdiv_eq_iff
#print axioms Square.orbit_eq_iff_cross
#print axioms Square.orbit_eq_imp_scale
#print axioms Square.scale_imp_orbit_eq
#print axioms Square.scale_unique
#print axioms Square.anchor_exists
#print axioms Square.anchor_unique
#print axioms Square.anchor_exists_arch
-- AtlasOrbitDecode (target-free): decoding of coupling addresses into the scale field; the AC-23 laws as equivariance of decoding, the nonlocal anchor V(f, n·s/x), zero rows, and the POINTWISE DENSITIES at decoded sites (prime 2Λ(n)wr = primeFoldDensity, pole, constant, compact-tail, far — not marginals: no joint measure or pushforward law is proved) — no resolver, no kernel, no readback, no positivity
...
#print axioms Square.primeDensityAt_eq
#print axioms Square.primeDensityAt_nonneg
#print axioms Square.poleDensityAt_nonneg
#print axioms Square.constDensityAt_nonneg
#print axioms Square.tailDensityAt_nonneg
#print axioms Square.farDensityAt_nonneg
-- AtlasPrimePowerFold: the canonical prime-power decomposition n = (spf n)^(ppExp n), Λ(n) = log(spf n) on prime-power addresses, Λ = 0 off them, and THE BOUNDED PRIME FOLD IS SUPPORTED ON THE PRIME-POWER ADDRESSES (primeFoldGram = primeFoldGramPP)
#print axioms Square.isPow_spec
#print axioms Square.ppExp_spec
#print axioms Square.vonMangoldt_prime_pow_addr
#print axioms Square.vonMangoldt_not_pp
#print axioms Square.primeFoldDirect_vanish
#print axioms Square.primeFoldGram_eq_pp
-- AtlasOrbitHaar (F1-free): the action groupoid of positive scalings (composition/identity/inverse up to Qeq), Haar windows with floors, THE INVARIANT HAAR SYSTEM haar_invariance (∫_{s·W} φ dt/t = ∫_W φ(s·) dt/t), the regular representation regRep with composition/identity, UNITARITY and THE ADJOINT proved by change of variables (not stored)
#print axioms Square.arrow_comp_tgt
#print axioms Square.arrow_comp_assoc
#print axioms Square.arrow_id_left
#print axioms Square.arrow_id_right
#print axioms Square.arrow_inv
#print axioms Square.haar_invariance
#print axioms Square.regRep_comp
#print axioms Square.regRep_one
...
-- couplingOfAdmissible_win_hi: the upper-window certificate s ≤ a+w of the admissible coupling address (from Admissible.hwin_hi)
#print axioms Square.couplingOfAdmissible_win_hi
-- AtlasField2 (target-free): certified two-variable fields (CField: uniform Lipschitz moduli in scale and Haar coordinate, bound, congruences), their product/sum/negation/scalar/composition closure (sourced constants of Rmul_lipschitz, lip_add_fl, lip_const_mul_left, the two-step estimate comp2_step), the Haar integral intT (certified in the scale by param_integral_lip) and the scale integral intX, and the plumbing that passes pointwise identities through integrals with INDEPENDENT certificates (congruence, difference, real scalar, zero, window-only agreement); local finite-sum lemmas. No target import, no sign
#print axioms Square.RsumN_add_f2
#print axioms Square.RsumN_neg_f2
#print axioms Square.RsumN_sub_f2
#print axioms Square.cfield_fc
#print axioms Square.abs_ofQ_le
#print axioms Square.abs_sub_tri
#print axioms Square.two_mod_combine
#print axioms Square.comp2_step
#print axioms Square.intT_lip
#print axioms Square.intT_fc
#print axioms Square.intU_congr_free
#print axioms Square.intU_congr_unit_free
#print axioms Square.intU_sub_free
#print axioms Square.intU_smul_free
#print axioms Square.intU_zero_free
#print axioms Square.intI_congr_free
#print axioms Square.intI_congr_unit_free
#print axioms Square.intI_sub_free
#print axioms Square.intT_congr_pt
#print axioms Square.intT_congr_win
#print axioms Square.intT_sub_pt
#print axioms Square.intT_zero_pt
#print axioms Square.intX_congr_pt
#print axioms Square.intX_congr_win
#print axioms Square.intX_sub_pt
-- AtlasCarrier5 (target-free): THE MEASURED FIVE-CHANNEL CARRIER Carrier5 (one certified field per channel), the SAME quadratic form inner5 on the cut and the cycle carrier with exactly the sourced channel densities times the split factor 4 (pole 4·2(1+1/x)wr on [1,B], prime 4·2Λ(m+1)wr, constant 4·(log4π+γ)wr, compact tail 4·2wr on [1+2^{-k},B], far 4·2·fc·wr with the scalar mass fc a parameter), the cut/cycle ANALYSES A_k f / B_k f (fiber coordinates (u∓v)/4 of the five channel fibers, global certificates from the coherent scale field), the pointwise split under every density (fiber_int_split), and the FOUR TARGET-FREE CHANNEL SPLITS poleGram/primeFoldGram/constGram/tailGram = cut Gram − cycle Gram and their sum atlasDefectGram_split = inner4(A_k f, A_k g) − inner4(B_k f, B_k g): exact identities of integrals, not a sign
#print axioms Square.mulF_F
#print axioms Square.aCoefF_F
#print axioms Square.bCoefF_F
#print axioms Square.wrF_F
#print axioms Square.xcl_lip1
#print axioms Square.xcl_abs_bd
#print axioms Square.poleDens5_F
#print axioms Square.primeDens5_F
#print axioms Square.constDens5_F
#print axioms Square.tailDens5_F
#print axioms Square.farDens5_F
#print axioms Square.poleW_den
#print axioms Square.poleW_num
#print axioms Square.tailLo_den
#print axioms Square.dilTL_den
#print axioms Square.dilTL_num
#print axioms Square.DF_F
#print axioms Square.ZF_F
#print axioms Square.WF_F
#print axioms Square.cutAnalysis5_pole
#print axioms Square.cutAnalysis5_prime
#print axioms Square.cutAnalysis5_const
#print axioms Square.cutAnalysis5_tail
#print axioms Square.cutAnalysis5_far
#print axioms Square.cycleAnalysis5_pole
#print axioms Square.cycleAnalysis5_prime
#print axioms Square.cycleAnalysis5_const
#print axioms Square.cycleAnalysis5_tail
#print axioms Square.cycleAnalysis5_far
#print axioms Square.dens_split_alg
#print axioms Square.fiber_int_split
#print axioms Square.poleGram_split
#print axioms Square.primeFoldDirect_split
#print axioms Square.primeFoldGram_split
#print axioms Square.constGram_split
#print axioms Square.tailGram_split
#print axioms Square.add_sub_add_c5
#print axioms Square.atlasDefectGram_split
-- AtlasColligation5 (target-free): THE SIGNED FIVE-CHANNEL ATLAS COLLIGATION atlasMatrix : Carrier5 → Carrier5 from cut data only — the Lipschitz reciprocal PkInvF = clampedInv_{1/B}(P_k(x̄)) (= PkInv on the band), the recovery fields recUF/recVF/recVFarF exact on the analyses, the scale integral xInt with Haar certificates, the Haar mass over [n,B] ≥ (X−m)/B with explicit reciprocal witness, the mate x̄·t̄/n, the cut-only reading integrand readF and THE NORMALIZED HAAR ORBIT READING readHaar (a genuine certified dx/max(x,1) integral over the scale window [n,B] ⊆ J_{k,n,t}, no point sampling, no refinement parameter), the REAL-SCALE READING IDENTITY readF_source = r(x̄)·U_n(t) (Uc_orbit + invSq_sq_mul_self), readHaar_source = U_n(t) exactly, the matrix (two-port cycle coordinates of the recovered source), EqOnSupport5, EXACT REPRODUCTION atlasMatrix_reproduces on the measured supports (error identically zero), inner5_congr_support, energy5_matrix_eq, THE RANGE BOUND IS THE SIGN (atlasMatrix_range_bound_iff: contraction on the range ⟺ cutEnergy − cycleEnergy ≥ 0) and colligation_range_bound_imp for EVERY reproducing map. No bound is proved or claimed
#print axioms Square.affineMap_ge_lo_c5
#print axioms Square.affineMap_le_hi_c5
#print axioms Square.intI_smul_free
#print axioms Square.PkClF_F
#print axioms Square.invBQ_num
#print axioms Square.invBQ_den
#print axioms Square.xcl_zero_le
#print axioms Square.PkInvF_F
#print axioms Square.atCl_F
#print axioms Square.recUF_F
#print axioms Square.recVF_F
#print axioms Square.recVFarF_F
#print axioms Square.xcl_idem
#print axioms Square.Wc_congr_x
#print axioms Square.Zc_congr_x
#print axioms Square.aCoefGa_congr
#print axioms Square.bCoefGa_congr
#print axioms Square.cut_tail_at_cl
#print axioms Square.recUF_source
#print axioms Square.recVF_source
#print axioms Square.recVFarF_source
#print axioms Square.xInt_lip
#print axioms Square.xInt_bd
#print axioms Square.xInt_fc
#print axioms Square.xInt_congr_smul
#print axioms Square.wnQ_num
#print axioms Square.wnQ_num_pos
#print axioms Square.upQ_add_wnQ_le_B
#print axioms Square.rOneCl_ge_invB
#print axioms Square.massFloor_den
#print axioms Square.massFloor_num_pos
#print axioms Square.hMass_ge
#print axioms Square.hMassInv_mul
#print axioms Square.tBand_ge_a
#print axioms Square.tBand_le
#print axioms Square.tBand_eq_of_win
#print axioms Square.tBand_abs_bd
#print axioms Square.invNQ_num
#print axioms Square.mateF_F
#print axioms Square.comp2F_F
#print axioms Square.readF_F
#print axioms Square.readHaar_F
#print axioms Square.read_alg
#print axioms Square.orbit_mate_alg
#print axioms Square.upR_nonneg
#print axioms Square.upQ_le_B
#print axioms Square.upR_le_S
#print axioms Square.xcl_le_S
#print axioms Square.mate_ge_a
#print axioms Square.c_le_xcl
#print axioms Square.readF_source
#print axioms Square.win_xcl_ge_n
#print axioms Square.readHaar_source
#print axioms Square.atlasMatrix_pole_F
#print axioms Square.atlasMatrix_prime_F
#print axioms Square.atlasMatrix_const_F
#print axioms Square.ZrecF_F
#print axioms Square.WrecF_F
#print axioms Square.atlasMatrix_tail_F
#print axioms Square.atlasMatrix_far_F
#print axioms Square.inWin_of_affine
#print axioms Square.atlasMatrix_reproduces
#print axioms Square.affine_pole_ge_one
#print axioms Square.affine_pole_le_B
#print axioms Square.affine_tail_ge_lo
#print axioms Square.affine_tail_le_B
#print axioms Square.inner5_congr_support
#print axioms Square.energy5_matrix_eq
#print axioms Square.atlasMatrix_range_bound_iff
#print axioms Square.colligation_range_bound_imp
-- AtlasFiveSplit (target side): the far channel identification farTailGram_k = farG(A_far) − farG(B_far) with fc = farCoef (far cycle coordinate 0, cut coordinate V/2, 4·½·½ = 1), THE ALL-PAIRS FIVE-CHANNEL NORMALIZATION source5_split_fixed: atlasDefectGram_k(f,g) + farTailGram_k(f,g) = inner5(A_k f, A_k g) − inner5(B_k f, B_k g), atlasMatrix_range_bound_iff_defect (the range contraction of the explicit matrix ⟺ atlasDefectGram_k(f,f) + farTailGram_k(f,f) ≥ 0), THE UNIVERSAL OBSTRUCTION colligation_range_bound_imp_defect (every reproducing colligation bounded on the range forces the defect sign — no locality/routing/asymptotic structure enters), and the conditional chains colligation_family_imp_dominance / atlasMatrix_family_imp_dominance (bounded at every level ⟹ CurrentArchDominatesPrime via defectSeq_nonneg_imp_dominance). The bound is NOT proved and dominance is NOT claimed
#print axioms Square.mul_mul_mul_comm_fs
#print axioms Square.quarter_four_fs
#print axioms Square.far_alg
#print axioms Square.farG_cut_eq
#print axioms Square.farG_cyc_zero
#print axioms Square.farTailGram_split
#print axioms Square.source5_split_fixed
#print axioms Square.atlasMatrix_range_bound_iff_defect
#print axioms Square.colligation_range_bound_imp_defect
#print axioms Square.colligation_family_imp_dominance
#print axioms Square.atlasMatrix_family_imp_dominance
-- AtlasCoherent5 (target-free): THE MEASURED SOURCE-COHERENT CARRIER SourceCoherent5 C k z as PROPOSITIONS about a cut carrier element — anchor agreement on the band (recVF = recVFarF for 1 ≤ x ≤ B, t in the Haar window) and the orbit law of the cut-only reading (r(x̄')·readF x t = r(x̄)·readF x' t for x̄, x̄' ≥ n, m < X); cutAnalysis5_coherent (every test's cut analysis is coherent), readAt = x̄·readF (the reading at one window scale), readAt_source (= U_n(f,t) on every analysis), readF_of_coherent, readHaar_eq_of_coherent (on a coherent element the normalized Haar average EQUALS the reading at every window scale — the dx/max(x̄,1) transport weight is not semantic data of a coherent element), and coherent_bound_imp_defect (a contraction bound of atlasMatrix on the coherent carrier forces energy5(A_k f) − energy5(B_k f) ≥ 0 for every test: at least the crux, never weaker); no sign asserted
#print axioms Square.cutAnalysis5_coherent
#print axioms Square.rOneClF_F
#print axioms Square.xcl_mul_rOne
#print axioms Square.readAt_source
#print axioms Square.readF_of_coherent
#print axioms Square.readHaar_eq_of_coherent
#print axioms Square.coherent_bound_imp_defect
-- AtlasAnchorExtract (target-free): THE BOUNDED ANCHOR EXTRACTOR BY GENUINE SCALE INTEGRATION — anchorAx z (t) = (∫_{[1+2^-k,B]} (q_k·A_pole − A_tail)(x̄,t) dx)/(∫_{[1+2^-k,B]} P_k(x̄)/4 dx) with the EXACT-RECOVERY WEIGHT P_k/4 (q_k·A_pole − A_tail = (P_k/4)·V; NOT the metric-dual density a_V⁻¹ = P_k²/(2(q_k²/(1+r)+1)); no pointwise division; anchorDen ≥ gap_k/(4B), reciprocal at the explicit witness 3·denLo.den), EXACT on every cut analysis at every Haar coordinate (numAx_source, anchorAx_source), and THE SOURCE-METRIC BOUND anchorAx_bound: ∫₀¹ 8wr·anchor² ≤ c_k·(poleG z.pole z.pole + tailG z.tail z.tail) for EVERY carrier element, c_k = (4B/gap_k)²·gap_k·2(B·M_K+1)² explicit, growing like 4^k at fixed context — no uniform control, not for the scheduled limit (Cauchy–Schwarz unit_cs_ax/anchorXInt_sq_le from innerI_cauchy_schwarz, the pointwise square estimate num_sq_le_ax, the Fubini swap fubini_ax from bern2D_general_swap_window, pole-window monotonicity intX_tail_le_pole_ax from riemannIntegralI_split_at) — a bound on the anchor by two cut energies, not a field, not a colligation bound, no sign claim
#print axioms Square.anchorXInt_eq_core
#print axioms Square.anchorXCore_lip
#print axioms Square.anchorXCore_fc
#print axioms Square.anchorXCore_bd
#print axioms Square.anchorXInt_lip
#print axioms Square.anchorXInt_bd
#print axioms Square.anchorXInt_fc
#print axioms Square.anchorXIntF_F
#print axioms Square.intI_smul_ax
#print axioms Square.intI_le_ax
#print axioms Square.intI_le_unit_ax
#print axioms Square.intU_le_ax
#print axioms Square.PkAx_F
#print axioms Square.densAx_F
#print axioms Square.qkAx_F
#print axioms Square.poleAx_F
#print axioms Square.tailAx_F
#print axioms Square.numAx_F
#print axioms Square.denLo_den
#print axioms Square.denLo_num_pos
#print axioms Square.xcl_zero_le_ax
#print axioms Square.anchorDen_ge
#print axioms Square.anchorDen_mul_inv
#print axioms Square.denInvAx_nonneg
#print axioms Square.denInvAx_le
#print axioms Square.anchorAx_F
#print axioms Square.aCoefGa_congr_ax
#print axioms Square.Zc_congr_x_ax
#print axioms Square.Wc_congr_x_ax
#print axioms Square.xcl_idem_ax
#print axioms Square.cutAnalysis5_tail_ax
#print axioms Square.half_half_eq_quarter_ax
#print axioms Square.half_two_eq_one_ax
#print axioms Square.numAx_source
#print axioms Square.densAx_const_t
#print axioms Square.anchorXInt_numAx_source
#print axioms Square.anchorAx_source
#print axioms Square.innerI_one_right
#print axioms Square.innerI_one_one
#print axioms Square.unit_cs_ax
#print axioms Square.pullTest_int
#print axioms Square.pullTest_inner
#print axioms Square.anchorXInt_sq_le
#print axioms Square.sq_sub_le_ax
#print axioms Square.sq_le_of_abs_le_ax
#print axioms Square.num_sq_le_ax
#print axioms Square.affineMap_zero_one_ax
#print axioms Square.joint_lip_ax
#print axioms Square.fubini_ax
#print axioms Square.intI_congr_w_ax
#print axioms Square.intT_nonneg_ax
#print axioms Square.intX_nonneg_ax
#print axioms Square.poleW_sub_dyQ
#print axioms Square.dyQ_le_one_ax
#print axioms Square.one_le_poleW_ax
#print axioms Square.dyQ_le_poleW
#print axioms Square.intX_tail_le_pole_ax
#print axioms Square.qBound_den
#print axioms Square.qBound_num
#print axioms Square.qk_abs_le
#print axioms Square.cOneAx_nonneg
#print axioms Square.numAx_sq_le
#print axioms Square.anchorXInt_numsq_le
#print axioms Square.sqAx_nonneg
#print axioms Square.tailDens5_nonneg
#print axioms Square.tailDens5_const_x
#print axioms Square.anchorAx_F_num
#print axioms Square.denLoInv_nonneg
#print axioms Square.gapR_nonneg
#print axioms Square.wsqInt_eq
#print axioms Square.anchor_sq_le
#print axioms Square.anchorNum_sq_le
#print axioms Square.pt_alg_ax
#print axioms Square.anchor_pt_le
#print axioms Square.anchorEnergy_le_iter
#print axioms Square.intX_add_ax
#print axioms Square.tailLo_add_gap
#print axioms Square.affineMap_ge_lo_ax
#print axioms Square.xcl_eq_on_tail
#print axioms Square.tailG_eq_wsq
#print axioms Square.tailDens5_le_poleDens5
#print axioms Square.poleDens5_nonneg
#print axioms Square.wsq_pole_le_poleG
#print axioms Square.anchorAx_bound
...
#print axioms Square.zero_le_of_one_le_R
...
#print axioms Square.Qle_zero_of_num_of
#print axioms Square.Qle_of_Rle_ofQ_of
#print axioms Square.Qle_Qmax_left_of
#print axioms Square.not_Qle_of_Qlt
#print axioms Square.ramp_nonneg
#print axioms Square.ramp_le_one
#print axioms Square.ramp_le_of_le
#print axioms Square.ramp_eq_zero_of_le
#print axioms Square.ramp_eq_one_of_ge
#print axioms Square.ramp_lip
#print axioms Square.ramp_congr
#print axioms Square.ramp_abs_le_one
#print axioms Square.CField.rampF_F
#print axioms Square.band_ge_R
#print axioms Square.band_le_R
#print axioms Square.band_le_of_le
#print axioms Square.band_ge_of_ge
#print axioms Square.CField.bandF_F
#print axioms Square.awQ_num_pos
#print axioms Square.uQ_den
#print axioms Square.uQ_num
#print axioms Square.uQ_num_pos
#print axioms Square.etaQ_den
#print axioms Square.etaQ_num
#print axioms Square.etaQ_num_pos
#print axioms Square.tLQ_den
#print axioms Square.tRQ_den
#print axioms Square.tLQ_lt_tRQ
#print axioms Square.a_le_tLQ
#print axioms Square.a_le_tRQ
#print axioms Square.Qmul_Qinv_self_of
#print axioms Square.Qinv_mul_self_of
#print axioms Square.ofQ_mul_inv_self_of
#print axioms Square.ofQ_inv_mul_self_of
#print axioms Square.Qadd_num_pos_of
#print axioms Square.uQ_le_one
#print axioms Square.etaQ_le_eighth
#print axioms Square.three_eta_le_one
#print axioms Square.four_eta_le_one
#print axioms Square.tailLo_num
#print axioms Square.tailLo_le_B
#print axioms Square.tailLo_le_upQ
#print axioms Square.one_le_upQ
#print axioms Square.upQ_add_one_le_B
#print axioms Square.upQ_sub_tailLo_num_pos
#print axioms Square.upQ_sub_tailLo_38_num_pos
#print axioms Square.anQ_den
#print axioms Square.anQ_num
#print axioms Square.awnQ_den
#print axioms Square.awnQ_num
#print axioms Square.lamF_F
#print axioms Square.muF_F
#print axioms Square.invEtaQ_den
#print axioms Square.invEtaQ_num
#print axioms Square.maskF_F
#print axioms Square.maskF_nonneg
#print axioms Square.maskF_le_one
#print axioms Square.maskF_le_ramp1
#print axioms Square.maskrF_F
#print axioms Square.massF_F
#print axioms Square.intI_window_congr
#print axioms Square.intI_ge_middle
#print axioms Square.xInt_ge_plateau
#print axioms Square.rEv_le_inv_a
#print axioms Square.rEv_nonneg
#print axioms Square.rEv_ge_inv_of_le
#print axioms Square.rEv_mul_t
#print axioms Square.awQ_den
#print axioms Square.anQ_mul_inv_a
#print axioms Square.awnQ_eq
#print axioms Square.anQ_eq
#print axioms Square.aw_sub_tR
#print axioms Square.tL_sub_a
#print axioms Square.w38_inv_aw
#print axioms Square.two_u38
#print axioms Square.four_eta
#print axioms Square.four_eta_le
#print axioms Square.an_r_le_n
#print axioms Square.lam_le_n
#print axioms Square.aw_r_ge_one
#print axioms Square.awn_r_ge_n
#print axioms Square.mu_ge_n
#print axioms Square.sub_add_eq_sub_sub_of
#print axioms Square.awn_r_ge_R
#print axioms Square.an_r_le_L
#print axioms Square.Rsub_le_Rsub_of
#print axioms Square.maskF_eq_one
#print axioms Square.mask_r_ge_invB
#print axioms Square.maskr_nonneg
#print axioms Square.cMass_den
#print axioms Square.cMass_num_pos
#print axioms Square.one_le_B_sub_n
#print axioms Square.one_le_upQ_sub_one
#print axioms Square.three_eta_le_38
#print axioms Square.four_eta_le_half
#print axioms Square.tailLo_add_half_le_upQ
#print axioms Square.massF_ge
#print axioms Square.band_ge_self_of_le
#print axioms Square.lam_ge_anr
#print axioms Square.mate_ge_a_of_lam
#print axioms Square.readF_source_fiber
#print axioms Square.Qlt_zero_inv_succ
#print axioms Square.diffBound_den
#print axioms Square.diffBound_num
#print axioms Square.diff_abs_bd
#print axioms Square.mask_diff_alg
#print axioms Square.epsK_den
#print axioms Square.mask_read_le_eps
#print axioms Square.mask_read_eq
#print axioms Square.readFiber_F
#print axioms Square.numF_F
#print axioms Square.numF_source
#print axioms Square.massInvF_mul
#print axioms Square.readFiber_source

-- AtlasJoint5 (target-free): THE JOINT SIGNED FIVE-CHANNEL MATRIX — the metric-dual weight a_V^{-1} = P_k²/(2(q_k²/(1+r)+1)) as a certified field with the explicit lower bound (1/B)²/D_max (dualWF_ge), the dual denominator ∫ a_V^{-1} ≥ gap_k·dualLo with reciprocal at an explicit witness, THE METRIC-DUAL ANCHOR anchorDual (exact on every analysis at every (x,t): anchorDual_source); atlasMatrixJoint with the fiber reading readFiber at the active places 1 ≤ m < X, U_1 = V at m = 0 (Λ(1) = 0), and the joint anchor as V in every port; EXACT REPRODUCTION atlasMatrixJoint_reproduces (error identically zero, no refinement parameter); the intrinsic RESYNTHESIS LAW JointSyn5 (z agrees on the supports with the cut coordinates of the source recovered from its own ports), inhabited by every analysis (cutAnalysis5_jointSyn); THE POINTWISE CANCELLATION cyc_sq_sub_cut_sq: B² − A² = u·v/4 (the atomic u², v² terms cancel), the cross form crossForm5, THE EXPANDED ENERGY IDENTITY energy5_joint_expand: energy5(T z) − energy5(synthJ z) = crossForm5 z for EVERY carrier element, energy5_joint_eq on the coherent carrier, and joint_bound_iff: energy5(T z) ≤ energy5(z) ⟺ crossForm5 z ≤ 0. The estimate is NOT proved; no sign is asserted
#print axioms Square.dualWF_F
#print axioms Square.qMQ_den
#print axioms Square.qMQ_num
#print axioms Square.dMaxQ_den
#print axioms Square.Qadd_one_num_pos_j
#print axioms Square.dMaxQ_num_pos
#print axioms Square.two_le_dMaxQ
#print axioms Square.dualDenF_le
#print axioms Square.dualLoQ_den
#print axioms Square.dualLoQ_num_pos
#print axioms Square.dualWF_ge
#print axioms Square.dualDenLo_den
#print axioms Square.dualDenLo_num_pos
#print axioms Square.dualDen_ge
#print axioms Square.dualDen_mul_inv
#print axioms Square.anchorDual_F
#print axioms Square.four_quarter_j
#print axioms Square.dualNumF_source
#print axioms Square.anchorDual_source
#print axioms Square.atlasMatrixJoint_pole_F
#print axioms Square.atlasMatrixJoint_prime_F
#print axioms Square.atlasMatrixJoint_prime0_F
#print axioms Square.atlasMatrixJoint_const_F
#print axioms Square.ZrecJ_F
#print axioms Square.WrecJ_F
#print axioms Square.atlasMatrixJoint_tail_F
#print axioms Square.atlasMatrixJoint_far_F
#print axioms Square.upR_zero_eq_one
#print axioms Square.atlasMatrixJoint_reproduces
#print axioms Square.synthJ_pole_F
#print axioms Square.synthJ_prime_F
#print axioms Square.synthJ_prime0_F
#print axioms Square.synthJ_const_F
#print axioms Square.synthJ_tail_F
#print axioms Square.synthJ_far_F
#print axioms Square.cutAnalysis5_jointSyn
#print axioms Square.neg_sub_eq_j
#print axioms Square.quarter_four_j
#print axioms Square.half_cross_j
#print axioms Square.cyc_sq_sub_cut_sq
#print axioms Square.dens_sq_alg
#print axioms Square.channel_cross_pt
#print axioms Square.crossF_F
#print axioms Square.gramX_cross
#print axioms Square.gramT_cross
#print axioms Square.prime_cross_m
#print axioms Square.energy5_joint_expand
#print axioms Square.energy5_synth_eq
#print axioms Square.energy5_joint_eq
#print axioms Square.joint_bound_iff

-- AtlasJointReadback (target side): crossForm5_range — on the range the cross form of the joint matrix is MINUS the level-k defect, crossForm5_k(A_k f) = −(atlasDefectGram_k(f,f) + farTailGram_k(f,f)); jointMatrix_bound_iff_defect (the joint bound on the range ⟺ the level-k defect sign); jointMatrix_family_imp_dominance; THE ASYMPTOTIC READBACK vanishing_slack_imp_dominance (defectSeq_j ≥ −δ_j with a regular slack δ_j → 0 along the schedule ⟹ CurrentArchDominatesPrime, via Rlim_le_Rlim), one_add_sq_slack, slack_of_eps_bound ((1+ε)²-bound with energy ≤ E ⟹ D_k + far_k ≥ −(2ε+ε²)E), jointMatrix_asymptotic_imp_dominance. No slack, no energy bound and no sign is asserted: the slack ε_k → 0 for the joint matrix is, on the range, exactly liminf D_k ≥ 0
#print axioms Square.energy5_joint_matrix_eq
#print axioms Square.crossForm5_range
#print axioms Square.neg_zero_j
#print axioms Square.jointMatrix_bound_iff_defect
#print axioms Square.jointMatrix_family_imp_dominance
#print axioms Square.vanishing_slack_imp_dominance
#print axioms Square.one_add_sq_expand_j
...
-- AtlasAnchorAutocorr (target-free): THE ANCHOR KERNEL IN AUTOCORRELATION FORM, ITS REGULARIZED LIMIT AND THE EDGE ESTIMATE — AnchorProfile (scale-constant, vanishing below a; anchorProfile_of_fullCoherent), the Haar autocorrelation data N_H, R_H, anchorKernel5_autocorr (AK_k = −2∫_1^B(1+1/x)R_H + 2ΣΛ(n)R_H(n) + (log4π+γ)N_H + 2∫_{1+2^{-k}}^B K_k(x̄)(R_H − N_H/x̄) − 2·fc·N_H), RH_zero_beyond_B, the mask support (maskF_zero_of_le_lam/_ge_mu), the regularity energy Reg_H = (w/a)·M·((L_√+1)M + (a+w)L) with RH_sub_NH_abs_le and tailACF_abs_le, the edge estimate anchorKernel5_edge_abs (|AK_{k'} − AK_k| ≤ 2^{1−k}·Reg_H, test-independent coefficient), the scheduled regular sequence and anchorKernelLimit := Rlim, anchorKernel5_limit_abs (|AK_k − AK_∞| ≤ 2^{1−k}·Reg_H), crossForm5_limit_abs on the coherent carrier, and the narrow-window scope primeAC_zero_of_narrow (w < a ⟹ the prime term vanishes identically). NO SIGN: AK_∞ ≤ 0 is not proved
#print axioms Square.anchorProfile_of_fullCoherent
#print axioms Square.smulQF_F_ac
#print axioms Square.subF_F_ac
#print axioms Square.intT_smul_pt
#print axioms Square.intT_congr_scale
#print axioms Square.intT_abs_le_M
#print axioms Square.four_smul_quarter_ac
#print axioms Square.dens_cross_ac
#print axioms Square.NHF_F
#print axioms Square.RHF_F
#print axioms Square.RHXF_F
#print axioms Square.NHconstF_F
#print axioms Square.constTerm_ac
#print axioms Square.farTerm_ac
#print axioms Square.poleACF_F
#print axioms Square.poleTerm_pt
#print axioms Square.poleTerm_ac
#print axioms Square.shiftUn_eq_shiftU_ac
#print axioms Square.primeTerm_m_ac
#print axioms Square.primeTerm_ac
#print axioms Square.tail_inner_ac
#print axioms Square.xcl_mul_rOne_ac
#print axioms Square.tailACF_F
#print axioms Square.tailTerm_pt
#print axioms Square.tailTerm_ac
#print axioms Square.anchorKernel5_autocorr
#print axioms Square.rOne_le_invB_ac
#print axioms Square.aw_invB_le_a
#print axioms Square.RH_zero_beyond_B
#print axioms Square.maskF_zero_of_le_lam
#print axioms Square.maskF_zero_of_ge_mu
#print axioms Square.rOne_le_one_ac
#print axioms Square.dist_one_le_innerXm_ac
#print axioms Square.Kfl_mul_dist_le_one_ac
#print axioms Square.add_mul_ac
#print axioms Square.sub_add_sub_ac
#print axioms Square.sqOneL_den
#print axioms Square.sqOneL_num
#print axioms Square.rOne_sub_one_le
#print axioms Square.invSq_sub_rOne_le
#print axioms Square.shift_arg_dist_ac
#print axioms Square.kOneQ_den
#print axioms Square.kOneQ_num
#print axioms Square.shift_diff_split_ac
#print axioms Square.anchor_shift_diff_le
#print axioms Square.edgeInt_eq
#print axioms Square.edge_pt_alg
#print axioms Square.regQ_den
#print axioms Square.regQ_num
#print axioms Square.wr_abs_le_ac
#print axioms Square.edgeInt_abs_le
#print axioms Square.RH_sub_NH_abs_le
#print axioms Square.tailACF_abs_le
#print axioms Square.dyQ_add_le_ac
#print axioms Square.dyQ_sub_num_pos_ac
#print axioms Square.dyQ_sub_le_ac
#print axioms Square.Kx_inert_ac
#print axioms Square.sub_one_of_one_add_ac
#print axioms Square.tail_window_dist
#print axioms Square.edgeW_den
#print axioms Square.edgeW_add_tailGap
#print axioms Square.tailLo_add_edgeW
#print axioms Square.tailGap_sub_edgeW
#print axioms Square.num_nonneg_of_Qeq
#print axioms Square.edgeW_le_tailGap
#print axioms Square.tailGap_sub_edgeW_num
#print axioms Square.tailAC_split
#print axioms Square.edgeBound_den
#print axioms Square.edgeBound_num
#print axioms Square.edgePiece_abs_le
#print axioms Square.add_cancel_ac
#print axioms Square.anchorKernel5_diff_edge
#print axioms Square.anchorKernel5_edge_abs
#print axioms Square.two_mul_le_two_pow_ac
#print axioms Square.edgeBound_sched_le
#print axioms Square.akSeq_close
#print axioms Square.akSeq_reg
#print axioms Square.Rle_self_add_ofQ_ac
#print axioms Square.sched_ge
#print axioms Square.anchorKernel5_limit_abs
#print axioms Square.crossForm5_limit_abs
#print axioms Square.RH_zero_of_scale_ge
#print axioms Square.RsumN_zero_ac
#print axioms Square.aw_le_a_mul_n_of_narrow
#print axioms Square.primeAC_zero_of_narrow

-- AtlasFarCoefStable (target side): farCoef_eq_of_pos — the far coefficient ∫_B^∞ K_k/x is independent of the level k (the floor is inert beyond B ≥ 2), so the far mass of the limiting anchor kernel is a single constant
#print axioms Square.farShift_eq_Bm1
#print axioms Square.farShift_congr
